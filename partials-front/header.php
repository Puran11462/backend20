        ...
        <body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="50" tabindex="0">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link gradient-text" href="about.php">About</a></li>
                    <li class="nav-item"><a class="nav-link gradient-text" href="menu.php">Menu</a></li>
                    <li class="nav-item"><a class="nav-link gradient-text" href="order.php">Order</a></li>
                    <li class="nav-item"><a class="nav-link gradient-text" href="book.php">Book a table</a></li>
                    <li class="nav-item"><a class="nav-link gradient-text" href="admin/login.php">Login</a></li>
